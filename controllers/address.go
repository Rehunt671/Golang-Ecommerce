...
func AddAddress() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		pointcursor,err := User.Collection.Aggregate(ctx,mongo.Pipeline(match_filter,unwind,group))
		if err != nil{
			c.IndentedJSON(500,"Internal server error")
		}
		...
		var size int32
		for _,addresses_no := range addressinfo {}
...
func EditHomeAddress() gin.HandlerFunc{
	return func(c *gin.Context){
		...
		_,err = User.COllection.UpdateOne(ctx,filter,update)
		if err != nil{
